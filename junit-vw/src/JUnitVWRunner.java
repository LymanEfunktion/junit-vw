 ...
 * @since 4.5
 */
public class JUnitVWRunner extends ParentRunner<FrameworkMethod> {
	...
	protected Description describeChild(FrameworkMethod method) {
		...
		if (description == null) {
			description = Description.createTestDescription(getTestClass().getJavaClass(), testName(method),
	...
	private Statement withMethodRules(FrameworkMethod method, List<TestRule> testRules, Object target,
			Statement result) {
